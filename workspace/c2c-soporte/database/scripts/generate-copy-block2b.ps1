param(
  ...
  [string] $OutputRoot = ".\database\generated\copy-block2b"
)
...
$sourceTable = "contabilizaciondocs"
$targetTable = "contabilizaciondocs_2026"
$whereClause = "fechaemision >= '2026-01-01' AND fechaemision < '2027-01-01'"
...
-- Crea tabla de ventana 2026 para contabilizaciondocs en staging_public.
...
Write-Host "Bloque 2B generado en: $outputDir"

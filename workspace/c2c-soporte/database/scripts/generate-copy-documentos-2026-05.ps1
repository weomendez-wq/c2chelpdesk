param(
  ...
  [string] $OutputRoot = ".\database\generated\copy-documentos-2026-05"
)
...
$targetTable = "documentos_2026_05"
$whereClause = "rr_gestion_soporte.fn_parse_dte_timestamp(fechaemision) >= timestamp '2026-05-01' AND rr_gestion_soporte.fn_parse_dte_timestamp(fechaemision) < timestamp '2026-06-01'"
...
-- Crea tabla de ventana mayo 2026 para documentos en staging_public.
...
Write-Host "Documentos mayo 2026 generado en: $outputDir"
